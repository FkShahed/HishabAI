...
const PRESET_ORBS: Record<string, OrbColorConfig> = {
  aurora: {
    ...
    orb1Dark: 'rgba(124, 58, 237, 0.22)', orb1Light: 'rgba(124, 58, 237, 0.10)',
    orb2Dark: 'rgba(6, 182, 212, 0.18)',  orb2Light: 'rgba(6, 182, 212, 0.08)',
    orb3Dark: 'rgba(236, 72, 153, 0.15)', orb3Light: 'rgba(244, 114, 182, 0.06)',
  },
  nebula: {
    // Deep Nebula: Electric Purple + Indigo + Magenta
    orb1Dark: 'rgba(139, 92, 246, 0.22)', orb1Light: 'rgba(139, 92, 246, 0.10)',
    orb2Dark: 'rgba(99, 102, 241, 0.18)',  orb2Light: 'rgba(99, 102, 241, 0.08)',
    orb3Dark: 'rgba(217, 70, 239, 0.15)', orb3Light: 'rgba(217, 70, 239, 0.06)',
  },
  emerald: {
    // Emerald Oasis: Mint Emerald + Teal + Sapphire
    orb1Dark: 'rgba(16, 185, 129, 0.22)', orb1Light: 'rgba(16, 185, 129, 0.10)',
    orb2Dark: 'rgba(20, 184, 166, 0.18)', orb2Light: 'rgba(20, 184, 166, 0.08)',
    orb3Dark: 'rgba(2, 132, 199, 0.15)',  orb3Light: 'rgba(2, 132, 199, 0.06)',
  },
  sunset: {
    // Sunset Glow: Amber Gold + Coral Orange + Rose Pink
    orb1Dark: 'rgba(249, 115, 22, 0.22)', orb1Light: 'rgba(249, 115, 22, 0.10)',
    orb2Dark: 'rgba(245, 158, 11, 0.18)', orb2Light: 'rgba(245, 158, 11, 0.08)',
    orb3Dark: 'rgba(244, 63, 94, 0.15)',  orb3Light: 'rgba(244, 63, 94, 0.06)',
  },
  cyberpunk: {
    // Cyberpunk Neon: Electric Blue + Cyan + Hot Violet
    orb1Dark: 'rgba(59, 130, 246, 0.22)', orb1Light: 'rgba(59, 130, 246, 0.10)',
    orb2Dark: 'rgba(6, 182, 212, 0.18)',  orb2Light: 'rgba(6, 182, 212, 0.08)',
    orb3Dark: 'rgba(168, 85, 247, 0.15)', orb3Light: 'rgba(168, 85, 247, 0.06)',
  },
  midnight: {
    // Midnight Velvet: Slate + Midnight Indigo + Deep Purple
    orb1Dark: 'rgba(71, 85, 105, 0.24)',  orb1Light: 'rgba(71, 85, 105, 0.10)',
    orb2Dark: 'rgba(67, 56, 202, 0.18)',  orb2Light: 'rgba(67, 56, 202, 0.08)',
    orb3Dark: 'rgba(88, 28, 135, 0.15)',  orb3Light: 'rgba(88, 28, 135, 0.06)',
  },
};
